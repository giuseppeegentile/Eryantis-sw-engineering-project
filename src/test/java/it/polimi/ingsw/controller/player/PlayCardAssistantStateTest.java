...
class PlayCardAssistantStateTest {
    ...
    @Test
    void testPlayCard(){ //non funziona
        init();
        ...
        AssistantCardModel cardOne = player1.getDeckAssistantCardModel().get(i);
        AssistantCardModel cardTwo = player2.getDeckAssistantCardModel().get(i);

        AssistantCardModel cardThree = player3.getDeckAssistantCardModel().get(i);
        AssistantCardModel cardFour = player4.getDeckAssistantCardModel().get(i);
