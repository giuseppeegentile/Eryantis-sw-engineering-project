...
class GameControllerAdvancedTest4 {
    ...
    public static void setUp() {
        ...
        gameController.incrementTest(8);
    ...
    void testingGameTurnAdvanced(){
        ...
        assertEquals("ExcludeColorInfluenceEffect", gameInstance.getPlayersModel().get(0).getCharacterDeck().get(0).getEffect().getClass().getSimpleName());
        assertEquals("ExchangeHallEntranceEffect", gameInstance.getPlayersModel().get(0).getCharacterDeck().get(1).getEffect().getClass().getSimpleName());
        ...
        PlayedCharacterCardMessage playedCharacterCardMessage = new PlayedCharacterCardMessage(gameController.getPlayerActive().getNickname(), gameInstance.getPlayersModel().get(0).getCharacterDeck().get(1));
        List<ColorPawns> students = new ArrayList<>(asList(ColorPawns.RED, ColorPawns.RED, ColorPawns.RED, ColorPawns.RED));
        Map<ColorPawns, Integer> studentsHall = new HashMap<>(Map.of(
                GREEN, 0,
                RED, 4,
                YELLOW, 0,
                PINK, 0,
        ...
        gameInstance.getPlayersModel().get(0).setStudentHall(studentsHall);
        List<ColorPawns> studentsFromHall = new ArrayList<>(students.subList(1,3));
        ...
        ChosenChangeEntranceHall chosenChangeEntranceHall = new ChosenChangeEntranceHall(gameController.getPlayerActive().getNickname(), studentsFromHall, studentsFromEntrance);
        gameController.onMessageReceived(chosenChangeEntranceHall);
        assertTrue(gameInstance.getPlayersModel().get(0).getStudentInEntrance().containsAll(studentsFromHall));
        ...
        gameController.onMessageReceived(playedCharacterCardMessage);
        MovedStudentFromCardToHall movedStudentFromCardToHall = new MovedStudentFromCardToHall(gameController.getPlayerActive().getNickname(), ((InitialConfigEffect) gameController.getPlayerActive().getCharacterDeck().get(2).getEffect()).getStudents().get(1));
